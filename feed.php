    ...
    <nav class="navigation">
        ...
        <div class="navigation__column">
            ...
            <form method="get" action="feed.php">
                ...
                ?>
                        <input type="text" name="search" placeholder="Search" value="<?php $_GET['caption']?>">
                <?php        
                    } else {
                ?>
            ...
            <div class="photo">
                <header class="photo__header">
                    ...
                    <div class="photo__user-info">
                        <span class="photo__author"><?= $_SESSION['profile']['username'] ?></span>
                        <span class="photo__location">Bandoeng</span>
                    </div>
                </header>
                <img src="<?php $images["url"] ?>" />
                <div class="photo__info">
                    ...
                    <span class="photo__likes"><?php $images["jLike"] ?></span>
