<?php
    ...
    if(isset($_POST['submit'])){
        $query_update_profile = mysqli_query($conn, "UPDATE profile SET username = '".$_POST['username']."', name = '".$_POST['name']."', website = '".$_POST['website']."', bio = '".$_POST['bio']."', email = '".$_POST['email']."', phone = '".$_POST['phone']."', gen = '".$_POST['gender']."' ");
        $query_update_user = mysqli_query($conn, "UPDATE user SET username = '".$_POST['username']."', email = '".$_POST['email']."' ");
    ...
    <nav class="navigation">
        ...
        <div class="navigation__column">
            <ul class="navigations__links">
                ...
                <li class="navigation__list-item">
                    <a href="upload-photo.php" class="navigation__link">
    ...
    <main id="edit-profile">
        <div class="edit-profile__container">
            <header class="edit-profile__header">
                ...
                <h4 class="edit-profile__username"><?php echo $_SESSION['profile']['username']; ?></h4>
            </header>
